export const BASE_PATH = import.meta.env.VITE_API_URL || "https://api.capybara.click" // <- Edit this string to your own API
export const INVITE_URL = import.meta.env.VITE_INVITE_URL || "https://invite.capybara.click" // <- Edit this string to your Invite link
